...
/**
 * This class will display int curr = NotepadPane.getSelectedIndex(); String
 * temp = textPanes.get(curr).getText();
 * textPanes.get(curr).setDocument(test.getDoc());
 * textPanes.get(curr).setText(temp); line numbers for a related text component.
 * The text component must use the same line height for each line.
 * TextLineNumber supports wrapped lines and will highlight the line number of
 * the current line in the text component.
 *
