    ...
    public Block parse()
    {
        ...
        else
        {
            ...
            if(didParse && (superBlock.getType() == BlockType.METHOD || superBlock.getType() == BlockType.JARVIS))
            {
                ...
                VarDeclaration_Parser p = (VarDeclaration_Parser) parsed;
                if(superBlock.getType() == BlockType.JARVIS)
                {
                    tempJ = (JARVIS_Block)superBlock;
                    tempJ.addVar(new Variables(tempV.getVarType(),tempV.getName(),p.getIsInit()));
                }
                else
                {
                    tempM = (Method_Block)superBlock;
                    tempM.addVar(new Variables(tempV.getVarType(),tempV.getName(),p.getIsInit()));
                }
